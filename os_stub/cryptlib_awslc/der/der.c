...
/** @file
 * DER (Distinguished Encoding Rules) format Handler Wrapper Implementation for AWS-LC.
 *
 * NOTE: AWS-LC supports d2i_PUBKEY_bio, BIO operations, EVP_PKEY_base_id/EVP_PKEY_id.
 * It does NOT have OSSL_DECODER. So we use BIO-based DER parsing for all key types.
 **/
