...
/** @file
 * SM3 digest Wrapper Implementation (unsupported by AWS-LC).
 **/
 ...
 * be used again.
 * SM3 context should be already correctly initialized by libspdm_sm3_256_init(), and should not be
 * finalized by libspdm_sm3_256_final(). Behavior with invalid SM3 context is undefined.
 *
 * If sm3_context is NULL, then return false.
