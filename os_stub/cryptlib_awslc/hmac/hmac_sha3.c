...
/** @file
 * HMAC-SHA3_256/384/512 Wrapper Implementation over AWS-LC.
 **/

#include "internal_crypt_lib.h"
#include <openssl/hmac.h>

extern void *hmac_md_new(void);
extern void hmac_md_free(void *hmac_md_ctx);
extern bool hmac_md_set_key(const EVP_MD *md, void *hmac_md_ctx,
                            const uint8_t *key, size_t key_size);
extern bool hmac_md_duplicate(const void *hmac_md_ctx, void *new_hmac_md_ctx);
extern bool hmac_md_update(void *hmac_md_ctx, const void *data,
                           size_t data_size);
extern bool hmac_md_final(void *hmac_md_ctx, uint8_t *hmac_value);
extern bool hmac_md_all(const EVP_MD *md, const void *data,
