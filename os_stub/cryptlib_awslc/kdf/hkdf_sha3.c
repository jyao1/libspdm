...
/** @file
 * HMAC-SHA3_256/384/512 KDF Wrapper Implementation over AWS-LC.
 *
...
extern bool hkdf_md_extract_and_expand(const EVP_MD *md, const uint8_t *key,
                                       size_t key_size, const uint8_t *salt,
                                       size_t salt_size, const uint8_t *info,
                                       size_t info_size, uint8_t *out,
                                       size_t out_size);
extern bool hkdf_md_extract(const EVP_MD *md, const uint8_t *key,
                            size_t key_size, const uint8_t *salt,
                            size_t salt_size, uint8_t *prk_out,
                            size_t prk_out_size);
extern bool hkdf_md_expand(const EVP_MD *md, const uint8_t *prk,
