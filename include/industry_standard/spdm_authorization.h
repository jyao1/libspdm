...
typedef struct {
    ...
    uint32_t credential_privileges;
...
#define SPDM_AUTH_USAP_SIGN_CONTEXT "user-usap signing"
#define SPDM_AUTH_USAP_SIGN_CONTEXT_SIZE \
    (sizeof(SPDM_AUTH_USAP_SIGN_CONTEXT) - 1)
...
#define SPDM_AUTH_ERROR_CODE_INVALID_RECORD 0x0a
#define SPDM_AUTH_ERROR_CODE_TERM_AUTH_PROC 0x0b
...
#define SPDM_AUTH_MESSAGE_SUPPORTED_RESET_TO_DEFAULT_CAP 0x20
...
/* Authorization Process ID - SHA-384 output */
#define SPDM_AUTH_AUTH_PROC_ID_SIZE 48

typedef struct {
    uint8_t id[SPDM_AUTH_AUTH_PROC_ID_SIZE];
...
/* START_AUTH Attributes bits */
#define SPDM_AUTH_START_AUTH_ATTRIBUTES_CONTINUE 0x1
...
/* END_AUTH Attributes bits (PersistMethod in bits [1:0]) */
#define SPDM_AUTH_END_AUTH_ATTRIBUTES_PERSIST_METHOD_MASK        0x3
#define SPDM_AUTH_END_AUTH_ATTRIBUTES_PERSIST_METHOD_ERASE       0x0
#define SPDM_AUTH_END_AUTH_ATTRIBUTES_PERSIST_METHOD_UNTIL_RESET 0x1
#define SPDM_AUTH_END_AUTH_ATTRIBUTES_PERSIST_METHOD_PERMANENT   0x2
...
#define SPDM_AUTH_RECORD_TYPE_ENCAP_MESSAGE_WITH_AUTH 1
#define SPDM_AUTH_RECORD_TYPE_RECORD_ERROR 2
#define SPDM_AUTH_RECORD_TYPE_AUTH_MESSAGE_WITH_AUTH 3
