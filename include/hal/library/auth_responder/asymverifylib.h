...
#ifndef AUTH_RESPONDER_ASYMVERIFYLIB_H
#define AUTH_RESPONDER_ASYMVERIFYLIB_H
...
extern bool libspdm_auth_device_requester_data_verify(
...
#endif /* AUTH_RESPONDER_ASYMVERIFYLIB_H */
