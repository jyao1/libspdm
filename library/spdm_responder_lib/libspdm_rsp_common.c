...
void libspdm_build_opaque_data_version_selection_data(libspdm_context_t *spdm_context,
                                                      ...
                                                      void *data_out)
{
    spdm_context->connection_info.secured_message_version = secured_message_version;
    ...
    spdm_version_number_t *secured_message_version)
{
    ...
    if (spdm_context->local_context.secured_message_version.secured_message_version_count != 0) {
        libspdm_process_opaque_data_supported_version_element (
            spdm_context, data_in_size, data_in, secured_message_version);
    }
...
libspdm_process_opaque_data_supported_version_data(libspdm_context_t *spdm_context,
                                                   ...
                                                   spdm_version_number_t *secured_message_version)
{
    return libspdm_process_opaque_data_for_responder_exchange(
        spdm_context, data_in_size, data_in, secured_message_version);
}